    ...
    <div>
      ...
      >
        {({ values, errors, touched, handleSubmit, isSubmitting
          ...
          >
            <h1 className="text-[4.5vh]">Add a new journal:</h1>
            <div className="form-control">
              <div className="form-control-input">
                <label htmlFor="title">Title</label>
                <Field type="text" name="title" placeholder="Write the journal's title." />
              ...
              <div className="form-control__collection">
                <label htmlFor="file" className="label-upload">Upload journal&rsquo;s main image</label>
                {addedPhotos &&
                  <>
