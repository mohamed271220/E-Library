...
const Product = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-3 relative">
      ...
      {
        true &&
        <div className="flex absolute bg-black rounded-lg bg-opacity-45 gap-[1vh] top-0 right-0 p-[1vh] ">
          <button className="btn-3 border-none bg-dim-blue p-3"><FiEdit2 color="white" /></button>
