...
const DeleteModal = ({ type, onClose, isOpen, id  }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col justify-center items-center gap-[5vh]">
                ...
                <button className="btn-3 bg-red-600 border-red-600 text-white hover:bg-red-800" onClick={() => deleteItem(type, id)}>Confirm</button>
