    ...
    <div className="relative">
      ...
      <AnimatePresence mode="wait">
        {isOpen && (
          <motion.dialog
            key="modal"
            className={`fixed overflow-y-auto ${isForm ? "top-4 mt-[15vh] m-auto " : "top-0 left-0"} transform -translate-x-1/2 -translate-y-1/2 ${isSearchForm ? 'py-0' : 'py-[2vh]'} px-[3vh] w-[30rem] h-[70vh] max-w-[90%] z-50 bg-white
          `}
            open
            variants={{
